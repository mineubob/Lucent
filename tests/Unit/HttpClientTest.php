...
class HttpClientTest extends TestCase
{
    ...
    public function test_http_client_download(): void
    {
        ...
        $this->assertTrue(file_exists(FileSystem::rootPath()."/storage/downloads/".$saved_path) && $response->successful());
    }
    ...
    public function test_http_client_download_404(): void
    {
        ...
        $this->assertFalse(file_exists(FileSystem::rootPath()."/storage/downloads/".$saved_path) && !$response->successful());
